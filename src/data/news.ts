...
const newsItems: NewsItem[] = [
  {
    ...
    excerpt:
      '브리츠메디가 ASLS KOREA 2026 춘계 학술대회에 참가하여 토로이달 코일 RF 기술과 TORR RF를 선보입니다. 라이브 시연과 기술 세미나를 통해 국내 의료진과 교류합니다.',
...
<h2>전시 및 시연 내용</h2>
<p>
브리츠메디 부스에서는 대표 제품인 <strong>TORR RF</strong>의 실물 전시와 함께, 토로이달 코일 기반 Multi-wave RF 기술의 원리를 설명하는 기술 세미나를 진행합니다. 또한 TORR RF의 라이브 시연을 통해 360도 균일 에너지 전달과 다층 시술 효과를 직접 확인할 수 있는 기회를 제공합니다.
</p>
...
<p>
브리츠메디는 이번 학회를 통해 국내 의료진들에게 토로이달 RF 기술의 임상적 가치를 알리고, 파트너십 확대의 기회로 삼고자 합니다. 부스 방문 및 세미나 참석을 희망하시는 분은 사전 등록 페이지를 통해 신청해 주시기 바랍니다.
</p>
`,
  },
  {
...
<p>
브리츠메디(BRITZMEDI)가 해외 디스트리뷰터 파트너 네트워크 <strong>40개국 돌파</strong>를 달성했습니다. 2019년 설립 이후 불과 6년 만에 이룬 성과로, 토로이달 코일 RF 기술의 글로벌 경쟁력과 K-의료기기에 대한 해외 시장의 높은 관심을 입증하는 결과입니다.
</p>
